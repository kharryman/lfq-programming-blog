        ...
        return (
            <div key="html_not_updating">
                <p>Use this code to update the $scope or $rootScope: <br />
                    <code>$scope.$apply(function()&#123;your code...&#125;)</code>
                    <div style={{ marginLeft: '100px' }}>or</div>
                    <code>$rootScope.$apply(function()&#123;your code...&#125;)</code>
                </p>
            </div>
        );
    }
        ...
        return (
            <div key="useful_directives">
                ...
                <div id="ng-keypress">
                    ...
                    <code><strong>ng-keypress="myKeyIsPressedFunction(event)"</strong></code>
                </div>
                <div id="ng-repeat">
                    <h3>ng-repeat:</h3>
                    Used to show a number of elements based on the length of a javascript array:<br />
                    <code><strong>ng-repeat="item in array"</strong></code>
                </div>
                <div id="ng-style">
                    <h3>ng-style:</h3>
                ...
                <div id="ng-switch-default">
                    ...
                    <code><strong>ng-switch-default</strong></code>                    
                </div>
            </div>
        );
    }
