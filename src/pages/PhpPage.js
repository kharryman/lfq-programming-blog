...
function PhpPage(props) {
    ...
    function getIntroJSX() {
        return (
            <div>
                PHP or Hypertext Preprocessor, is a backend language used to fetch and send data from the server, or<br />
                to pre-process hyper text or HTML, before rendering.
            </div>
        );
    }
