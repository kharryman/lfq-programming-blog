...
function VmWarePage(props) {
    ...
    function getIntroJSX() {
        return (
            <div>
                VMWare is a popular software tool which allows you to create virtual machines on almost any platform.<br />
                For example, you can run a Mac computer on a Window machine, or vice-versa(Windows on a Mac machine).
            </div>
        );
    }
